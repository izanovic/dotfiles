...
set("n", "<leader>ue", function()
  toggle_neotree_side("right")
end, { desc = "Neo-tree (right side)" })

vim.keymap.set("x", "<leader>ts", function()
  require("config.i18n").wrap_in_translation()
end, { desc = "Wrap visual selection with $t()" })

vim.keymap.set("n", "<leader>ta", function()
  require("config.i18n").add_to_translation_files()()
end, { desc = "Add key to translation files" })
